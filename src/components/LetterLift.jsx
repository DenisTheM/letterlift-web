  ...
  return(<div style={{minHeight:"100vh",background:"#FBF8F5",fontFamily:"'Lora',Georgia,serif",color:"#2C2C2C",overflowX:"hidden"}}>
    ...
    <section ref={hR} style={{...sa(hV),maxWidth:"1200px",margin:"0 auto",padding:"80px 6% 60px",display:"flex",alignItems:"center",gap:"60px",flexWrap:"wrap"}}>
      <div style={{flex:"1 1 460px",minWidth:"300px"}}><h1 style={{fontSize:"clamp(36px,5vw,56px)",fontWeight:400,lineHeight:1.15,margin:"0 0 20px"}}>Briefe, die<br/>wirklich <span style={{fontStyle:"italic",color:"#5B7B6A"}}>ankommen</span>.</h1><p style={{fontSize:"18px",lineHeight:1.7,color:"#6B6360",margin:"0 0 36px",maxWidth:"480px",fontFamily:"'DM Sans',sans-serif"}}>Personalisierte Motivationsbriefe, generiert mit KI, gedruckt auf echtem Papier. Jeden Brief vor dem Versand bearbeiten.</p>
        ...
        <div style={{marginTop:"24px",display:"flex",gap:"20px",fontSize:"13px",fontFamily:"'DM Sans',sans-serif",color:"#8A8480"}}><span>✓ Ab CHF 3.33/Brief</span><span>✓ Jeden Brief editierbar</span><span>✓ Echte Post</span></div></div>
      <div style={{flex:"1 1 340px",minWidth:"280px",display:"flex",justifyContent:"center"}}><div style={{position:"relative",width:"340px",height:"380px"}}><div style={{position:"absolute",top:"30px",left:"20px",width:"280px",background:"#fff",borderRadius:"4px",padding:"36px 32px",boxShadow:"0 12px 40px rgba(0,0,0,0.08)",transform:"rotate(-2deg)",fontSize:"15px",lineHeight:1.8,color:"#3A3A3A"}}><div style={{marginBottom:"14px",color:"#5B7B6A",fontStyle:"italic"}}>Liebste Sari,</div><div>Erinnerst du dich an Lissabon? Die alte Frau, der Portwein?</div><div style={{marginTop:"14px",fontStyle:"italic",color:"#8A7F76"}}>Du triffst mutige Entscheidungen.</div><div style={{marginTop:"18px",color:"#5B7B6A"}}>Deine Lena</div></div>
    ...
    <section ref={wR} style={{...sa(wV),maxWidth:"1000px",margin:"0 auto",padding:"80px 6%"}}><h2 style={{fontSize:"28px",fontWeight:400,textAlign:"center",margin:"0 0 40px"}}>So funktioniert's</h2>
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:"24px"}}>{[{i:"✍️",t:"Erzählen",d:"Hobbies, Erinnerungen, Stärken."},{i:"🤖",t:"KI schreibt",d:"Eine dramaturgische Briefserie."},{i:"✏️",t:"Du prüfst",d:"Jeden Brief vor Versand bearbeiten."},{i:"✉️",t:"Post kommt",d:"Echte Briefe im Briefkasten."}].map((s,i)=><div key={i} style={{background:"#fff",borderRadius:"16px",padding:"28px 22px",boxShadow:"0 2px 12px rgba(0,0,0,0.04)",textAlign:"center"}}><div style={{fontSize:"32px",marginBottom:"12px"}}>{s.i}</div><div style={{fontSize:"16px",fontWeight:600,fontFamily:"'DM Sans',sans-serif",marginBottom:"8px"}}>{s.t}</div><div style={{fontSize:"13px",fontFamily:"'DM Sans',sans-serif",color:"#7A7470",lineHeight:1.6}}>{s.d}</div></div>)}</div></section>
    ...
    <footer style={{padding:"28px 6%",textAlign:"center",fontSize:"13px",fontFamily:"'DM Sans',sans-serif",color:"#B0A9A3"}}>© 2026 LetterLift · Zürich · Datenschutz · AGB</footer>
