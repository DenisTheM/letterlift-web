...
export default function App() {
  ...
  const renderStep=()=>{
    ...
    case"address":{const COUNTRIES=[{id:"CH",label:"🇨🇭 Schweiz"},{id:"DE",label:"🇩🇪 Deutschland"},{id:"AT",label:"🇦🇹 Österreich"},{id:"OTHER",label:"🌍 Anderes Land anfragen"}];return(<div><SH t={isSelf?"Wohin sollen die Briefe kommen?":"Wohin sollen die Briefe geschickt werden?"} s={isSelf?"Deine Adresse bleibt vertraulich.":"Die Adresse des Empfängers."}/>
